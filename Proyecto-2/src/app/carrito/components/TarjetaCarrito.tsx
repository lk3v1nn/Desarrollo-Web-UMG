export default function TarjetaCarrito(prop: {nombre: string, descripcion: string, cantidad: string}) {
    return (
        <a
            href="#"
            className="w-full mt-2 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 bg-white border-gray-200  bg-opacity-50"
        >
            <img
